import { Body, Button, Card, CardItem, Container, Content, Fab, Icon, Text, Toast } from 'native-base';
...
function EvolutionScreen({ navigation }) {
	...
	async function deleteEvolution() {
		...
		try {
			...
			navigation.navigate('EvolutionList', { id: idPaciente, refresh: idPaciente });
		}
	}
	...
	const renderEvolutionInfo = () => {
		...
		const { fecha, motivoConsulta, descripcion } = evolution;
