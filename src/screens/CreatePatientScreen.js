...
const CreatePatientScreen = ({ navigation }) => {
    ...
    const { nombre, apellido, dni, fechaNacimiento, obraSocial, plan, numAfiliado, telefono, antecedentes, medicacionHabitual, alergias, cirugias } = state;
    ...
    async function cargarPaciente() {
        try {
            ...
            navigation.navigate("PatientList", { refresh: true });
        } catch (error) {
            console.error(error);
            // Mensaje de error
            Toast.show({
